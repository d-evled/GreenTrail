...
enum Picker {
    ...
    enum PickerError: Error, LocalizedError {
        ...
        var errorDescription: String? {
            ...
            case .denied:
                return NSLocalizedString("You have explicitly denied permission for media capture. Please open Permissions/Privacy/Camera and enable camera access for this application.", comment: "")
            }
        }
    }
